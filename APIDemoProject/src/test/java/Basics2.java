...
public static void main(String[] args) throws IOException {
		...
		//content of file to string -> content of file can convert  into Byte -> Byte data String
		
		RestAssured.baseURI = "https://rahulshettyacademy.com";
		
		String response = given().log().all().queryParam("key", "qaclick123").header("Content-Type","application/json")
		.body(new String(Files.readAllBytes(Paths.get("C:\\Users\\HP\\eclipse-workspace\\APIDemoProject\\src\\test\\resources\\JsonFiles\\addPlaceAPI.json"))))
